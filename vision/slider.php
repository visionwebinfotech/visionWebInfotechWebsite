    ...
    <section id="page-top">
        ...
        <div id="main-slide" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated3">
                                <span><strong>Vision Web</strong> for the highest</span>
                            </h1>
                ...
                <div class="item">
                    <img class="img-responsive" src="images/slider4.jpg" alt="slider">
                    
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated1">
                    		  <span>Welcome to <strong>Vision</strong></span>
                    	    </h1>
                ...
                <div class="item">
                    <img class="img-responsive" src="images/slider3.jpg" alt="slider">
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated2">
